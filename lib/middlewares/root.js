...
module.exports = function(req, res, next) {
	...
	res.locals.userIsAdmin = res.locals.authenticated && req.user.roles && req.user.roles.indexOf('admin') > -1;
	res.locals.userIsModerator = res.locals.authenticated && req.user.roles && req.user.roles.indexOf('moderator') > -1;
